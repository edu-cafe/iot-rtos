...
void TaskPrio3 (void *pdata)
{
	...
	pdata = pdata;
	while(1) {
		Puts("--->Task3:Sem_Request!!\n");
		.................
		sprintf(buff,"Task3:Sem_Pend(data1:%d)...!!\n", data1);
		Puts(buff);
		my_delay(1);
		data1++;
		sprintf(buff,"Task3:Sem_Post(data1:%d)...!!\n", data1);
		Puts(buff);
		..............
		OSTimeDlyHMSM(0, 0, 3, 0);
		sprintf(buff,"Task3_End...!!\n");
		Puts(buff);
	}
}
...
void TaskPrio5 (void *pdata)
{
	...
	while(1) {
		.............
		sprintf(buff,"Task5:Sem_Pend(data1:%d)...!!\n", data1);
		Puts(buff);
		my_delay(3);
		data1 += 10;
		sprintf(buff,"Task5:Sem_Post(data1:%d)...!!\n", data1);
		Puts(buff);
		.............
		OSTimeDlyHMSM(0, 0, 2, 0);
		sprintf(buff,"Task5_End...!!\n");
		Puts(buff);
	}
}
...
void TaskPrio7 (void *pdata)
{
	...
	while(1) {
		...........
		sprintf(buff,"Task7:Sem_Pend(data1:%d)...!!\n", data1);
		Puts(buff);
		my_delay(2);
		data1 += 100;
		sprintf(buff,"Task7:Sem_Post(data1:%d)...!!\n", data1);
		Puts(buff);
		.............
		OSTimeDlyHMSM(0, 0, 1, 0);
		sprintf(buff,"Task7_End...!!\n");
		Puts(buff);
	}
}
