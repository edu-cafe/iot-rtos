...
#define  PROBE_COM_CFG_TCPIP_EN                    DEF_DISBLED  /* Configure TCP/IP communication availability.         */
...
#define  PROBE_COM_CFG_STR_IN_BUF_SIZE                  1024    /* Configure size of string input  buf   (see Note #3a).*/
...
#define  PROBE_TCPIP_CFG_TASK_PRIO                         7    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                           8    /*  (c) Set task priority.                              */
