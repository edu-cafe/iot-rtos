...
#define WRITE_REG_STM(REG, VAL)   ((REG) = VAL)
#define READ_REG_STM(REG)         ((REG))
#define MODIFY_REG(REG, CLEARMASK, SETMASK)  WRITE_REG_STM((REG), (((READ_REG_STM(REG)) & (~CLEARMASK)) | (SETMASK)))
