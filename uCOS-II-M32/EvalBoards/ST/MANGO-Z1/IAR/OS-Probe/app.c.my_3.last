...
static  OS_STK         App_Task_LED1_Stack[APP_TASK_START_STK_SIZE];
static  OS_STK         App_Task_LED2_Stack[APP_TASK_START_STK_SIZE];
static  OS_STK         App_Task_LED3_Stack[APP_TASK_START_STK_SIZE];
...
static void App_LED2_Task(void *p_arg)
{
    (void)p_arg;
...
static void App_LED3_Task(void *p_arg)
{
    (void)p_arg;
...
#if 0
    os_err = OSTaskCreateExt((void (*)(void *)) App_LED1_Task,  /* Create led task */
                    (void          * ) 0,
                    ...
                    (INT16U          )(OS_TASK_OPT_STK_CLR | OS_TASK_OPT_STK_CHK));
#endif
	os_err = OSTaskCreate((void (*)(void *)) App_LED1_Task,  /* Create led task */
                    (void          * ) "Led1",
                    (OS_STK        * )&App_Task_LED1_Stack[APP_TASK_START_STK_SIZE - 1],
                    (INT8U           ) APP_TASK_LED1_PRIO
                    );
...
#if 0
    os_err = OSTaskCreateExt((void (*)(void *)) App_LED2_Task,  /* Create led task */
                    (void          * ) 0,
                    (OS_STK        * )&App_Task_LED2_Stack[APP_TASK_START_STK_SIZE - 1],
                    (INT8U           ) APP_TASK_LED2_PRIO,
                    (INT16U          ) APP_TASK_LED2_PRIO,
                    (OS_STK        * )&App_Task_LED2_Stack[0],
                    (INT32U          ) APP_TASK_START_STK_SIZE,
                    (void          * )0,
                    (INT16U          )(OS_TASK_OPT_STK_CLR | OS_TASK_OPT_STK_CHK));
#endif
	os_err = OSTaskCreate((void (*)(void *)) App_LED2_Task,  /* Create led task */
                    (void          * ) "Led2",
                    (OS_STK        * )&App_Task_LED2_Stack[APP_TASK_START_STK_SIZE - 1],
                    (INT8U           ) APP_TASK_LED2_PRIO
                    );
...
#if (OS_TASK_NAME_SIZE >= 9)
    OSTaskNameSet(APP_TASK_LED2_PRIO, "LED 2", &os_err);
#endif

    OSTimeDlyHMSM(0, 0, 0, 100);

#if 0
    os_err = OSTaskCreateExt((void (*)(void *)) App_LED3_Task,  /* Create led task */
                    (void          * ) 0,
                    (OS_STK        * )&App_Task_LED3_Stack[APP_TASK_START_STK_SIZE - 1],
                    (INT8U           ) APP_TASK_LED3_PRIO,
                    (INT16U          ) APP_TASK_LED3_PRIO,
                    (OS_STK        * )&App_Task_LED3_Stack[0],
                    (INT32U          ) APP_TASK_START_STK_SIZE,
                    (void          * )0,
                    (INT16U          )(OS_TASK_OPT_STK_CLR | OS_TASK_OPT_STK_CHK));
#endif
	os_err = OSTaskCreate((void (*)(void *)) App_LED3_Task,  /* Create led task */
                    (void          * ) "Led3",
                    (OS_STK        * )&App_Task_LED3_Stack[APP_TASK_START_STK_SIZE - 1],
                    (INT8U           ) APP_TASK_LED3_PRIO
                    );
...
#if (OS_TASK_NAME_SIZE >= 9)
    OSTaskNameSet(APP_TASK_LED3_PRIO, "LED 3", &os_err);
#endif
