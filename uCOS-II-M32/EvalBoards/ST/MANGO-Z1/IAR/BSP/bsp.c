...
//added by SOO
#define  BSP_GPIOB_LED1		DEF_BIT_09
#define  BSP_GPIOB_LED2		DEF_BIT_05
...
static  void  BSP_LED_Init (void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE); 
    gpio_init.GPIO_Pin   = BSP_GPIOB_LED1 | BSP_GPIOB_LED2 | BSP_GPIOB_LED3;
...
void  BSP_LED_On (CPU_INT08U led)
{
    switch (led) {
        case 0:
             GPIO_ResetBits(GPIOB, BSP_GPIOB_LED1 | BSP_GPIOB_LED2 | BSP_GPIOB_LED3);
             break;
...
void  BSP_LED_Off (CPU_INT08U led)
{
    switch (led) {
        case 0:
             GPIO_SetBits(GPIOB, BSP_GPIOB_LED1 | BSP_GPIOB_LED2 | BSP_GPIOB_LED3);
             break;
